                                    ...
                                    switch (formState) {
                                        case FormStates.HELP:
                                            return (<>
                                                ...
                                                <ul className="list-disc pl-10">
                                                    <li className="mb-2"><span className="italics">Better Corners: </span>Currently corners can only be a single tile.</li>
                                                    <li className="mb-2"><span className="italics">Preferences for Numerical Limitations: </span>Maximum substitutable color counts and graphical editor snap size should be user settings.</li>
                                                    <li className="mb-2"><span className="italics">Deleting Components Causes Crashes: </span>Deleting components that are used lower in the workspace configuration, for example presets that are used in windows, can cause crashes.</li>
                                                    <li className="mb-2"><span className="italics">New Workspace: </span>There is no way to start an entirely new workspace.</li>

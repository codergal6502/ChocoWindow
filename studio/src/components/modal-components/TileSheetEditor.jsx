...
const TileSheetEditor = ({ tileSheet, onTileSheetChange, onTileSheetDelete, onReturnToCanvas }) => {
    ...
    return (<>
        ...
        <div className="flex justify-between">
            ...
            {canPropogateDelete && <button onClick={() => onTileSheetDelete(tileSheet.id)} className="bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-500">Delete Tile Set</button>}
        </div>
    </>)
}

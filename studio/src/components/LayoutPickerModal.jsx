                ...
                <div className="bg-white rounded-lg shadow-lg  flex relative dark:bg-gray-600">
                    <div className="flex-grow p-6 bg-white rounded-lg dark:bg-gray-600 dark:text-gray-300">
                        ...
                        <div className="flex justify-between">
                            <button onClick={() => { onReturnToEditor(selection) }} className="m-2 w-[12em] bg-gray-500 text-white font-bold py-2 px-4 rounded hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-500">Close</button>

                    ...
                    <div className="flex-grow p-6 bg-white rounded-lg dark:bg-gray-600 dark:text-gray-300">
                        <div className="h-full overflow-y-auto">
                            ...
                            <div className="flex justify-between">
                                ...
                                <button onClick={onReturnToEditor} className="bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-500">Return to Editor</button>
                            </div>
                        </div>
                    </div>
                </div>
